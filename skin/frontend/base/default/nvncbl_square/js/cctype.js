...
{
	if (!iconsContainer) iconsContainer = document.getElementById('nvncbl-square-accepted-cards');
	...
	var img = document.getElementById('nvncbl_square_' + cardType + '_type');
	if (!img) return;

	img.className = 'active';
	iconsContainer.className = 'input-box nvncbl-square-detected';
};
